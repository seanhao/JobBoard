...
// Set up monk
var monk = require('monk');        //monk 用來連接mongoDB
 ...
 */
 ...
 module.exports.search = function *search() {
  ...
  //var search = yield posts.find({$text:{$search: ''}})
  this.body = yield render('search')
  
};
*/
module.exports.search = function *search() {
  var a = yield parse.searchname;
  var postList = yield posts.find({$text:{$search: a }});
  this.body = yield render('result',{ posts: postList });
};
